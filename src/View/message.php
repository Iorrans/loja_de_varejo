...
<body>
    ...
    <?php
        ...
        <article class="w-64 text-white bg-green-700 rouded p-9">
            <p class="text-center">
        ...
        ?>
          ...
          <article class="w-64 text-white bg-orange-700 rouded p-9">
            <p class="text-center">
        ...
        <article class="w-64 text-white bg-red-700 rouded p-9">
            <ul>
                <?= $_SESSION['msg_error']?>
            </ul>
                <a class="underline" href="#" onclick="window.history.back()">Voltar</a>
